...
The project’s data and code are stored in a GitHub repository (link: https://github.com/Jiaqi987/Loan-Risk-FPGrowth-Analysis) and have been assigned a persistent DOI via Zenodo (DOI: 10.5281/zenodo.16966284). For citations, use:

> Data and code are from: v1.1: Loan Risk FPGrowth Analysis (Data & Code), accessible via DOI: 10.5281/zenodo.16966284 or the GitHub repository.
